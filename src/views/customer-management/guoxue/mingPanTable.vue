  ...
  <div>
    <table class="heavier-text">
      ...
      <template v-if="tableItem.closeSolarRow">
        <tr>
          <td width="7%" rowspan="4"
              :style="{ 'line-height': nameLineHeight }" class=" new no-internal-borders
                          vertical-text"
          >
          ...
          <td style="width:13%;"
              :style="paddingStyle( 'lunarYear')"
              class="new no-internal-borders"
          >{{ tableItem.lunarYearChinese ? tableItem.lunarYearChinese : tableItem.lunarYear  }}
          </td>
          <td style="width:10%;"
              :style="paddingStyle( 'lunarMonth')"
              class="new no-internal-borders"
          >{{ tableItem.lunarMonth }}
          </td>
          <td style="width:12%;"
              :style="paddingStyle( 'lunarDay')"
              class="new no-internal-borders"
          >{{ tableItem.lunarDay }}
          </td>
          <td style="width:11%;"
              :style="paddingStyle( 'lunarHh')"
              class="new no-internal-borders"
          >{{ tableItem.closeLunarH ? tableItem.lunarHh : '' }}
          </td>
          <td style=" width:30%;padding-left:4px;padding-right:4px;" rowspan="4"
              class="new no-internal-borders"
          >
            {{ tableItem.gaiYao }}
          </td>
      ...
      <template v-else>
        <tr>
          <td width="7%" rowspan="5"
              :style="{ 'line-height': nameLineHeight }"
          ...
          <td style="width:10%"
              :style="paddingStyle( 'solarYear')"
              class="new no-internal-borders"
          >{{ tableItem.solarYear }}
          </td>
          <td style=" width:10%"
              :style="paddingStyle( 'solarMonth')"

              class="new no-internal-borders"
          >{{ tableItem.solarMonth }}
          </td>
          <td style=" width:12%"
              :style="paddingStyle( 'solarDay')"

              class="new no-internal-borders"
          >{{ tableItem.solarDay }}
          </td>
          <td style=" width:11%"
              :style="paddingStyle( 'solarHh')"

              class="new no-internal-borders"
          >
            {{ tableItem.closeSolarH ? tableItem.solarHh : '' }}
          </td>
          <td style=" width:30%;padding-left:4px;padding-right:4px;" rowspan="5"
              class="new no-internal-borders"
          >
            {{ tableItem.gaiYao }}
          </td>
      ...
      <tr>
        ...
        <td
            :style="paddingStyle('baZhiYear')"
            class="new no-internal-borders"
        >{{ tableItem.baZhiYear }}
        </td>
        <td
            :style="paddingStyle('baZhiMonth')"

            class="new no-internal-borders"
        >{{ tableItem.baZhiMonth }}
        </td>
        <td
            :style="paddingStyle('baZhiDay')"
            class="new no-internal-borders"
        >{{ tableItem.baZhiDay }}
        </td>
        <td
            :style="paddingStyle('baZhiHh')"

            class="new no-internal-borders"
        >{{ tableItem.closeBaZhiH ? tableItem.baZhiHh : '' }}
        </td>
      </tr>
      <tr>
        <td colspan="2"  class="new no-internal-borders">五行：</td>
        <td
            :style="paddingStyle('wuXinYear')"
