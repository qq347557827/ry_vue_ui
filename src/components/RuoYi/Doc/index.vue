<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="wechatDate">
    ...
    <el-table v-loading="loading" :data="customerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="weChat" />
      <el-table-column label="${comment}" align="center" prop="height" />
      <el-table-column label="${comment}" align="center" prop="weight" />
      <el-table-column label="${comment}" align="center" prop="loseWeight" />
      ...
      <el-table-column label="${comment}" align="center" prop="wechatDate" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="weChat">
          <el-input v-model="form.weChat" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        ...
        <el-form-item label="${comment}" prop="weight">
          <el-input v-model="form.weight" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="${comment}" prop="loseWeight">
          <el-input v-model="form.loseWeight" type="textarea" placeholder="请输入内容" />
        </el-form-item>
        ...
        <el-form-item label="${comment}" prop="district">
          <el-input v-model="form.district" type="textarea" placeholder="请输入内容" />
        </el-form-item>
...
<script>
import { listCustomer, getCustomer, delCustomer, addCustomer, updateCustomer } from "@/api/customer_order_goods/customer";
